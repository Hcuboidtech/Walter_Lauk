...
open class LocaleHelper {
    ...
    companion object {
        ...
        lateinit var languageEditor: SharedPreferences.Editor
        ...
        fun persist(context: Context, language: String) {
            languagePreferences = PreferenceManager.getDefaultSharedPreferences(context)
            languageEditor = languagePreferences.edit()
            languageEditor.putString(SELECTED_LANGUAGE, language)
